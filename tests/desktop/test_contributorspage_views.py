...
class TestContributorsPageViews():
    ...
    def test_page_first_level_views_from_home(self, mozwebqa):      
        ...
        utils.find_element_wait_assert_click(self._loc_contributors_header)
        
        #[H] find links in the menu
        links = utils.find_elements_and_wait(self._loc_contributors_links,None)
        num_links = len(links)
        ...
        for i in range(num_links):
            ...
            utils.find_element_and_wait(self._loc_contributors_header,None).click()
